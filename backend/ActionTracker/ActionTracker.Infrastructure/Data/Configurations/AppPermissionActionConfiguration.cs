...
public class AppPermissionActionConfiguration : IEntityTypeConfiguration<AppPermissionAction>
{
    public void Configure(EntityTypeBuilder<AppPermissionAction> builder)
    {
