...
public class AppPermissionAction
{
    public Guid Id { get; set; }

    /// <summary>Internal name used as a key (e.g. "View", "Create", "Delete").</summary>
    ...
    /// <summary>Controls display order in the permission matrix header.</summary>
